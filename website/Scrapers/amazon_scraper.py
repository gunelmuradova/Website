...
class amazon_scraper(Scraper):
    def __init__(self, **kwargs):
        self.item = kwargs['item']
        self.driver = amazon_driver.get.driver()
        self.url = 'https://www.amazon.com/s?k=computer&ref=nb_sb_noss_1'
    ...
    def extract_data(self, page_data):
        ...
        results = soup.find.all('div', {'data-component-type': 's-search-result'})
        api = {'data':[]}
        shipping = None
